...
Preloader.prototype = {
  preload: function () {
    //Preload all the images and data that are going to be used in the game
    ...
    var foocy = this.game.add.sprite(
      this.world.centerX,
      this.world.centerY,
      "preloaderbar"
    );
    ...
    this.load.image(
      "highscore_bild",
      "./assets/images/HIGHSCORE_bakgrund5.png"
    );
    ...
    this.load.bitmapFont(
      "anuswiper_font_rod",
      "./assets/fonts/bitmap/superswiper_rod.png",
      "./assets/fonts/bitmap/superswiper_feedback.fnt"
    );
    this.load.bitmapFont(
      "anuswiper_font_green",
      "./assets/fonts/bitmap/superswiper_green.png",
      "./assets/fonts/bitmap/superswiper_feedback.fnt"
    );
    this.load.bitmapFont(
      "anuswiper_font_rosa",
      "./assets/fonts/bitmap/superswiper_rosa.png",
      "./assets/fonts/bitmap/superswiper_feedback.fnt"
    );
    ...
    this.load.spritesheet(
      "button",
      "./assets/images/spritesheets/THE_START_KNAPP.png"
    );
    this.load.spritesheet(
      "HS_button",
      "./assets/images/spritesheets/THE_HIGH_KNAPP.png"
    );
    this.load.spritesheet("back", "./assets/images/spritesheets/BACK.png");
    this.load.spritesheet(
      "S_button",
      "./assets/images/spritesheets/THE_SETT_KNAPP.png"
    );
    this.load.spritesheet(
      "muteMusic",
      "./assets/images/spritesheets/MUTE_MUSIC.png"
    );
    this.load.spritesheet(
      "unMuteMusic",
      "./assets/images/spritesheets/UNMUTE_MUSIC.png"
    );
    this.load.spritesheet(
      "muteSound",
      "./assets/images/spritesheets/MUTE_SOUND.png"
    );
    this.load.spritesheet(
      "unMuteSound",
      "./assets/images/spritesheets/UNMUTE_SOUND.png"
    );
    this.load.spritesheet(
      "credits",
      "./assets/images/spritesheets/CREDITS.png"
    );
    this.load.spritesheet(
      "tryAgain",
      "./assets/images/spritesheets/TRY_AGAIN.png"
    );
    this.load.spritesheet(
      "backToMenu",
      "./assets/images/spritesheets/MAIN_MENU_2.png"
    );
